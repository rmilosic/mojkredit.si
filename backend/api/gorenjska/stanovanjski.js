...
module.exports.handler = (event, context, callback) => {
  ...
  function calculateFixed () {
    ...
    var get_params = `id=16&f_znesek=${queryData["creditAmount"]}&f_placa=&f_mes_obv=&f_trajanje_meseci=${queryData['creditTime']}&f_trajanje_leta=&
    f_obm=&f_status=1&f_zavarovanje=1&f_dan_koriscenja=01&f_varcevanje=0`;
  ...
  function calculateVariable () {
    ...
    var get_params = `id=12&f_znesek=${queryData["creditAmount"]}&f_placa=&f_mes_obv=&f_trajanje_meseci=${queryData['creditTime']}&f_trajanje_leta=&f_obm=&f_status=1&f_zavarovanje=1&f_dan_koriscenja=02&f_varcevanje=0`
