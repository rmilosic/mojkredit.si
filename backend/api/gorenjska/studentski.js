...
module.exports.handler = (event, context, callback) => {
  ...
  function calculateFixed () {
    ...
    var get_params = `id=9&f_znesek=${queryData["creditAmount"]}&f_placa=&f_mes_obv=&f_trajanje_meseci=${queryData['creditTime']}&f_trajanje_leta=&f_status=1&f_zavarovanje=-2&f_namen=1&f_dan_koriscenja=02`;
