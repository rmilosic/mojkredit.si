...
module.exports.handler = (event, context, callback) => {
  ...
  const post_options = {
    ...
    "headers": {
      ...
      "Referer": "https://www.sberbank.si/pripomocki/izracuni-in-primerjave/avto-kredit",
  ...
  function calculateFixed () {
    var fixed_post_options = {
      "data": `id=6&nacinZavarovanja=${queryData['creditInsurance']}&namenKredita=2&oblikaSodelovanja=${queryData["cooperation"]}&valuta=1&vrstaOM=1&znesekKredita=${queryData['creditAmount']}
