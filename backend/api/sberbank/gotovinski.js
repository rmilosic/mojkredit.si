...
module.exports.handler = (event, context, callback) => {
  ...
  function calculateFixed () {
    var fixed_post_options = {
      "data": `id=26&nacinZavarovanja=${event['creditInsurance']}&namenKredita=1&oblikaSodelovanja=2&valuta=1&vrstaOM=1&znesekKredita=${event['creditAmount']}
  ...
  function calculateVariable () {
    var variable_post_options = {
      "data": `id=26&nacinZavarovanja=${event['creditInsurance']}&namenKredita=1&oblikaSodelovanja=2&valuta=1&vrstaOM=2&znesekKredita=${event['creditAmount']}
      &odplacilnaDoba=${event['creditTime']}&zadnjaMesecnaAnuiteta=0&elektronskiNaslov=&format=html`,
      "options": post_options
    }
