...
module.exports.handler = (event, context, callback) => {
  ...
  function calculateFixed () {
    var fixed_post_options = {
      "data": `id=4&nacinZavarovanja=${queryData['creditInsurance']}&namenKredita=1&oblikaSodelovanja=${queryData["cooperation"]}&valuta=1&vrstaOM=1&znesekKredita=${queryData['creditAmount']}
  ...
  function calculateVariable () {
    var variable_post_options = {
      "data": `id=4&nacinZavarovanja=${queryData['creditInsurance']}&namenKredita=1&oblikaSodelovanja=2&valuta=1&vrstaOM=2&znesekKredita=${queryData['creditAmount']}
      &odplacilnaDoba=${queryData['creditTime']}&zadnjaMesecnaAnuiteta=0&elektronskiNaslov=&format=html`,
      "options": post_options
    }
