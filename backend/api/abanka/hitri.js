...
module.exports.handler = (event, context, callback) => {
  ...
  function returnCalcultion () {
    ...
    // var data = {"namenId": 3, "zavarovanjeId": 10, "komitentnost": true, "placaNaTRR": true, "vrstaIzracunaId": 0, "znesekKredita": queryData['creditAmount'], "doba": 36 };
      ...
      res.on('data', function(chunk) {
        ...
        zlib.gunzip(buffer, function(err, decoded) {
          ...
          responseList.map((response) => {
            functions.extractLoanDataGeneric(response);
          });
